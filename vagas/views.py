...
def NovaTarefa(request, id_vaga):
    titulo = request.POST.get('titulo')
    ...
    try:
        ...
        messages.add_message(request, constants.ERROR, 'Erro ao adicionar uma nova tarefa')

    return redirect(f'/vagas/vaga/{id_vaga}')


def RealizarTarefa(request, id):
...
def EnviaEmail(request, id_vaga):
